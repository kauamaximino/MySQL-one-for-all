...
INSERT INTO
    `SpotifyClone`.`plans` (`type_plan`, `value`)
VALUES
    ('gratuito', 0.00),
    ('pessoal', 6.99),
    ('familiar', 7.99),
...
INSERT INTO
    `SpotifyClone`.`artists` (`name_artist`)
VALUES
    ('Walter Phoenix'),
    ('Peter Strong'),
    ('Lance Day'),
...
INSERT INTO
    `SpotifyClone`.`album` (`artist_id`, `name_album`, `release_date`)
VALUES
    (1, 'Envious', 1990),
    (1, 'Exuberant', 1993),
...
INSERT INTO
    `SpotifyClone`.`song` (`album_id`, `name_song`, `duration`)
VALUES
    (1, "Soul For Us", 200),
...
INSERT INTO
    `SpotifyClone`.`user` (`name`, `age`, `hist_id`, `plan_id`, `sign_date`)
VALUES
...
INSERT INTO
    `SpotifyClone`.`user_favorite_artist` (`user_id`, `artist_id`)
VALUES
    (1, 1),
    (1, 3),
    (1, 4),
